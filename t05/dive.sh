...
echo '   && curl -sL https://deb.nodesource.com/setup_10.x | bash && apt-get  install -y nodejs git-core && npm install pm2 -g --no-optional && npm install yarn@1.9.4 -g \' >> Dockerfile
